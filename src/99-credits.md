...
Symbulator and its documentation, in all its versions up to this date, have been made by me, [**Roberto Perez-Franco**](http://roberto.perez-franco.com). I started coding it as an engineering student at the Technological University of Panama (Universidad Tecnológica de Panamá) in [Azuero](https://ls.utp.ac.pa/), and the timeline below has the dates.

...
$$
\begin{aligned}
&(5\sqrt{3}/17-20/17)e^{-t} \cos(2t) \\
&+ (-20\sqrt{3}/17-5/17)e^{-t} \sin(2t) \\
&+ (80\sqrt{3}/17+193/34)e^{-t/2}+(9/2-5\sqrt{3})e^{-t}
\end{aligned}
$$
:::
::: only 9
::: result voltage of node 1
\begin{aligned}
v_{1} &= (5\sqrt{3}/17-20/17)e^{-t} \cos(2t) \\
&+ (-20\sqrt{3}/17-5/17)e^{-t} \sin(2t) \\
&+ (80\sqrt{3}/17+193/34)e^{-t/2}+(9/2-5\sqrt{3})e^{-t}
\end{aligned}
:::
...
$$
\begin{aligned}
&(-245\sqrt{3}/34-20/17)e^{-t} \cos(2t) \\
&+ (245/34-20\sqrt{3}/17)e^{-t} \sin(2t) \\
&+ (80\sqrt{3}/17+193/34)e^{-t/2}+(5\sqrt{3}/2-9/4)e^{-t}
\end{aligned}
$$
:::
::: only 9
::: result voltage of node 2
\begin{aligned}
v_{2} &= (-245\sqrt{3}/34-20/17)e^{-t} \cos(2t) \\
&+ (245/34-20\sqrt{3}/17)e^{-t} \sin(2t) \\
&+ (80\sqrt{3}/17+193/34)e^{-t/2}+(5\sqrt{3}/2-9/4)e^{-t}
\end{aligned}
:::

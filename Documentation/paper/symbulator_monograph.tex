...
% Roberto Perez-Franco, via Claude (Fable 5)
%
...
% source is the author's 2000--2001 graduation thesis (references/
...
\vspace{0.2cm}
{\large \emph{via} Claude (Fable 5)\par}
\vspace{3cm}
...
piece of evidence is the author's graduation thesis of
...
thesis2000}. The decisive encounter came in 1998, while the author
was taking Circuit Theory~II: he met \emph{Syrup}, Joe Riel's
...
preface and the first four chapters, and what survives---working
notes between the translators still visible in the
margins---is preserved in the references archive beside the Spanish
original. Its preface recasts the thesis's opening promise in the
second person: ``The purpose of this book is to teach you the art
of symbolic circuit simulation.''
...
the 2001 calculator and the 2026 port agree to the last digit.
...
Symbulator 9 is built on Python and SymPy, and the author thanks their
...
four appendices; 89 worked problems with provenance. English
translation by D.~Burkett and T.~Hutcheson as \emph{The Symbulator
Book}, left unfinished at the preface, notice, and chapters~1--4.
Both the Spanish original and the surviving translation are

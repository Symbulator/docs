...
wrong''~\cite[Recs.]{thesis2000}. The thesis was later translated
to English by two of Symbulator's own users, Doug Burkett and Tim
Hutcheson, under the title \emph{The Symbulator
Book}~\cite[Acks.]{thesis2000}.
...
Book}. Preserved in this monograph's \code{references/} archive
(\code{2000\_thesis/}).

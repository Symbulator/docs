...
`src/98-nr12-sampler.md`, pulls every `::: result` panel out of it, and asks
...
hand, or a `gen.py` that starts rounding again, both fail here.
    ...
    py Documentation\\tools\\nr12\\check_card_truth.py
    py Documentation\\tools\\nr12\\check_card_truth.py --prove-red
...
CHAPTER = os.path.join(runner.DOCS, "src", "98-nr12-sampler.md")

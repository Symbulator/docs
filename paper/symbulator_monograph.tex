...
were run on every entry that admits one: 194 nodal systems and 143
mesh systems in each entry's own domain, and 319 and 247 respectively
under a wider sweep that runs every circuit and takes the transient
entries in FD. All of them agree with the classic solve, and none
differ. That sweep is what promoted the feature from an experiment to
part of the program.
